...
.git/:
	curl --user 'your_name_(or_your_organization/company/team)' https://api.github.com/user/repos --data '{"name":"data_profilling","description":"Statistical analyzing and reviewing data"}'
	test -f README.rst || echo "data_profilling" >> README.rst
	git init
	git add --all
	git commit --message "First commit"
	git remote add origin https://github.com/your_name_(or_your_organization/company/team)/data_profilling.git
