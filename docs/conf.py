...
module_dir = os.path.join(__location__, "../src/data_profilling")
...
project = u'data_profilling'
copyright = u'2020, Your name (or your organization/company/team)'
...
try:
    from data_profilling import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'data_profilling-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'data_profilling Documentation',
